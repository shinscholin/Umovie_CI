          ...
          <div class="col-lg">
            <div class="p-5">
              ...
              <form class="user" method="post" action="<?= base_url ('auth/register'); ?>">
                ...
                <div class="form-group">
                  <input type="date" class="form-control form-control-user" id="birthdate" name="birthdate" placeholder="Birth Date" <?= set_value('birthdate');?>>
